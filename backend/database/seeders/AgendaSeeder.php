    ...
    public function run(): void
    {
        ...
        foreach ($kelasList as $kelas) {
            Agenda::create([
                ...
                'Kelas_Id' => $kelas->Kelas_Id,  // ← ADA isinya
                'Ekstrakulikuler_Id' => null,    // ← NULL untuk perkelas
        ...
        if ($ekskuls->isNotEmpty()) {
            ...
            foreach ($gurus as $guru) {
                ...
                if ($kelas) {
                    // Buat agenda ekskul untuk 2 ekskul pertama saja (biar tidak terlalu banyak)
                    foreach ($ekskuls->take(2) as $ekskul) {
                        Agenda::create([
                            'Guru_Id' => $guru->Guru_Id,
                            'Kelas_Id' => $kelas->Kelas_Id,          // ← ADA isinya
                            'Ekstrakulikuler_Id' => $ekskul->Ekstrakulikuler_Id,  // ← ADA isinya
